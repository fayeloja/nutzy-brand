  ...
  return (
    <>
      ...
      <div className="flex flex-col text-center justify-center items-center mt-20 md:mt-40 mx-auto px-6 md:px-24 md:mb-20">
        <h1 className="hero-title text-accent-red text-4xl md:text-7xl">
          CONTACT US
        </h1>
      ...
      {/* INFO CARDS */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 md:px-24 px-6 mb-20 gap-6 md:gap-10 justify-center">
        {/* LOCATION */}
